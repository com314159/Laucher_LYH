...
import com.lyh.laucher_lyh.app.utils.ShellUtil.CommandResult;
...
public class PackageUtil {
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        CommandResult commandResult = ShellUtil.execCommand(command.toString(), !isSystemApplication(context), true);
