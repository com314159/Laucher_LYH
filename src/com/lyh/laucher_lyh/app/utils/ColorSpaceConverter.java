 ...
 * ColorSpaceConverter
 * 
 * @author dvs Created Jan 15, 2004
 */
public class ColorSpaceConverter {
	...
	private static double[][] Mi = { { 3.24071, -0.969258, 0.0556352 },
			{ -1.53726, 1.87599, -0.203996 }, { -0.498571, 0.0415557, 1.05707 } };

	private static ColorSpaceConverter mInstance;

	public static ColorSpaceConverter getInstance() {
		if (mInstance == null) {
			synchronized (ColorSpaceConverter.class) {
				if (mInstance == null) {
					mInstance = new ColorSpaceConverter();
				}
			}
		}
		return mInstance;
